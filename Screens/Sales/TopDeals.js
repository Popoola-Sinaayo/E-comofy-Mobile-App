...
import main from "../../assets/cloth.png";
import googles from "../../assets/googles.png";
import clothes from "../../assets/round-neck.png";
  ...
  return (
    ...
    >
      <ScrollView style={{ width: "95%" }} showsVerticalScrollIndicator={false}>
        ...
        <View className="mt-5">
          <Text className="font-bold text-3xl">Top Deals</Text>
          <Text className="font-normal text-lg">
            Check out the top deals for you
          </Text>
        </View>
        ...
        <View className="flex-row items-center justify-between mt-8">
          ...
          <TouchableOpacity onPress={() => navigation.navigate("TopDeals")}>
            ...
            >
              <Text className="text-white">Top deals</Text>
            </View>
          </TouchableOpacity>
        ...
        <View>
            ...
            <View style={{ width: "100%" }}>
              <View className="pl-10 pb-5">
                <Text className="text-xl font-semibold">
                  2 in 1 Men Sunset Beach Print Sets
                </Text>
          ...
          <ScrollView>
            ...
            <View className="flex-row justify-between mt-3">
              <View className="flex-1">
                <Image source={googles} className="w-200 h-200" />
              </View>
              <View>
                <Image source={clothes} />
              </View>
