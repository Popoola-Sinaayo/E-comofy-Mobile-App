    ...
    <View style={styles.container}>
      <View style={styles.containerChild}>
        <View style={styles.mainImage}>
          <Image source={payment} style={{ width: 300, height: 300 }} />
        </View>
        <View style={styles.text}>
          <Text style={styles.mainText}>Easy payment</Text>
          <Text style={styles.subText}> Easy and smooth payment method</Text>
          <Text style={styles.subText}>
            using bank cards, transfers or cash
          </Text>
        </View>
        <View style={styles.frameView}>
          <Image source={ellipse2} />
          <Image source={ellipse1} className="mr-1 ml-1" />
